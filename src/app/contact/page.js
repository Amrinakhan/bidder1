        ...
        <div className="container">
          <div className="row g-lg-4 gy-5 align-items-center">
            ...
            <div className="col-lg-7">
              <div className="contact-form-area" style={{ background: "#F7F7F7", padding: "40px", borderRadius: "8px" }}>
                <form>
                  <div className="row">
                    ...
                    <div className="col-md-12">
                      <div className="form-inner">
                        <button className="primary-btn btn-hover" type="submit" style={{ backgroundColor: "#6EA500", borderColor: "#6EA500" }}>
                          Submit Now
